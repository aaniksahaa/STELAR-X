...
public class TreeNode implements TreePrinter.PrintableNode {
    ...
    // Branch support and length fields for post-processing
    public String supportValue;  // Posterior probability or other support measure
    public double branchLength;  // Branch length from coalescent theory
    ...
    public TreeNode setTaxon(Taxon tx){
        this.taxon = tx;
        return this;
    }
